...
const AdminContainer = () => {
  ...
  // useEffect(() => {
  //   setMenu({
  //     tabFadeNew: document.getElementById("new"),
  //     tabFadeList: document.getElementById("list"),
  //   });
  // }, []);

  // const handleOnClick = () => {
  //   if (menu.tabFadeNew.classList.contains("active")) {
  //     menu.tabFadeNew.classList.remove("active");
  //     menu.tabFadeList.classList.add("active");
  //     menu.tabFadeList.classList.add("in");
  //   } else {
  //     menu.tabFadeNew.classList.add("active");
  //     menu.tabFadeList.classList.remove("active");
  //   }
  // };
