      ...
      <div className="row">
        <div className="col s12">
          ...
          <p>
            ...
            institución. No se puede reducir Fe y Alegría meramente a una red de
            escuelas, emisoras y programas educativos. Fe y Alegría es la puesta
            en marcha de un conjunto de ideales que se siembran en personas y en
            distintas instancias sociales.
            <br /> <br />
            Ser movimiento implica la permanente desestabilización creativa, la
            relectura continua de la realidad en una actitud de comprobada
            búsqueda, con grandes dosis de audacia, de inconformidad, de
            autocrítica constante, de modo que las prácticas educativas y el
            hacer pedagógico vayan respondiendo a las exigencias y los retos que
            plantea la realidad siempre cambiante y el empobrecimiento y
      ...
      <div className="row">
        ...
        <div className="row">
          <div className="col s12 l8">
            <div>
              <p>
                ...
                negociación cultural, a empoderarlos, es decir, capacitarlos con
                voz y con poder para hacerlos sujetos de la transformación de
                sus condiciones de vida y de la sociedad de la exclusión. La
                miseria y la exclusión están ligadas, en definitiva, a la falta
                de voz y de poder de los grupos populares. Un pueblo ignorante o
                superficialmente educado será siempre víctima de liderazgos
                enfermizos, y vivirá en la espera de mesianismos salvadores y
                bajo la amenaza de fanatismos que proliferarán en mil formas de
                intolerancia
              </p>
            </div>
          </div>
          <div className="col s12 l4">
            <div className="center">
              <img src={childrens} alt="Niños de Fe y Alegría" />
            </div>
          </div>
        </div>
      </div>
